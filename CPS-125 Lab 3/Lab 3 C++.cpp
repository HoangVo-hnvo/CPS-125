...
int main(){
    //Exercise 1
    int a,b,c,d;
    cout <<"Enter 4 numbers (you can enter multiple numbers by separating it with spaces): ";
    cin >> a >> b >> c >> d; //scanf("%d %d %d %d",&a,&b,&c,&d);
    ...
    printf("\nThe square root of the sum of the squares of the numbers, divided by the sum of all the numbers: %.2lf\n", ((sqrt((pow(a,2)+pow(b,2)+pow(c,2)+pow(d,2))))/(a+b+c+d)));
    ...
    printf("The volume of your sphere is %lf meters cubed.\n",volume);
